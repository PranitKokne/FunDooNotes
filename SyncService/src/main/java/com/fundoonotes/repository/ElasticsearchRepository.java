...
public interface ElasticsearchRepository<T> {
	 ...
	 * 
	 * @param index
	 *            index to which the document must be indexed.
	 * @param type
	 *            type of the elasticsearch index.
	 * @param id
	 *            id to which the document will get indexed.
	 * @param document
	 *            document containing the data in json format.
	 */
	 ...
	 * 
	 * @param index
	 *            index to which the document must be updated.
	 * @param type
	 *            type of the elasticsearch index.
	 * @param id
	 *            id to which the document will get updated.
	 * @param document
	 *            document containing the data in json format.
	 */
	 ...
	 * 
	 * @param index
	 *            index from which the document must be deleted.
	 * @param type
	 *            type of the elasticsearch index.
	 * @param id
	...
	/**
	 * Purpose: This method will retrieve the document from the elasticsearch index
	 * based on the document id.
	 * 
	 * @param index
	 *            index from which the document must be retrieved.
